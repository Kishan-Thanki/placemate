          ...
          `}>
            <div className="flex items-center justify-between">
              <div>
                ...
                `}>
                  Welcome back! Here's the placement status as of {new Date().toLocaleDateString('en-US', { 
                    year: 'numeric', 
                    month: 'long', 
                    day: 'numeric' 
                  })}.
 ...
 */
export function Section({ title, description, children, action = null, className = '' }) {
  const { isDark } = useTheme();
