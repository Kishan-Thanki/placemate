...
import { LayoutDashboard, Building2, CalendarDays, Users, Plus, FileText, Briefcase, ChevronLeft, ChevronRight, Moon, Sun, UserSquareIcon, UserRound, DraftingCompassIcon, HomeIcon } from 'lucide-react';
          ...
          <div className={`px-3 py-3 border-t ${isDark ? 'border-gray-700' : 'border-gray-200'} space-y-2`}>
            ...
            <div className={`${isDark ? 'bg-gray-700' : 'bg-gray-50'} rounded-lg ${collapsed ? 'p-2 flex justify-center' : 'px-3 py-2 flex items-center gap-3'}`}>
              <div className="w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center overflow-hidden">
                <span className="text-white text-sm font-semibold leading-none">S</span>
              </div>
              {!collapsed && (
                <div className="flex-1 min-w-0">
                  <p className={`text-sm font-medium truncate ${isDark ? 'text-white' : 'text-gray-900'}`}>Student</p>
