        ...
        <div className="grid grid-cols-12 items-center h-16 gap-4">
          ...
          <div className="col-span-12 lg:col-span-4 flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-3">
              <img src={logoUrl} alt="Placemate Logo" className="h-8 w-8 rounded" />
              <span className={`text-xl font-bold hidden sm:block ${isDark ? 'text-white' : 'text-gray-900'}`}>
                Placemate
              </span>
            </div>
          </div>
          ...
          <div className="col-span-12 lg:col-span-4 flex items-center justify-end space-x-3">
                  ...
                  <div className="p-4">
                    ...
                    <div className="mt-3 space-y-3">
                      {notifications.map((notification) => (
                        <div key={notification.id} className={`p-3 rounded-lg transition-colors cursor-pointer ${isDark ? 'hover:bg-gray-700' : 'hover:bg-gray-50'}`}>
                    ...
                    <div className="mt-3 pt-3 border-t border-gray-200 dark:border-gray-700">
                      <button className={`text-sm w-full text-center py-2 rounded-lg transition-colors ${isDark ? 'text-blue-400 hover:bg-gray-700' : 'text-blue-600 hover:bg-gray-50'}`}>
            ...
            <div className="relative">
              ...
              >
                ...
                <span className="hidden md:block text-sm font-medium">{fullName || 'User'}</span>
                ...
                `}>
                  <div className="py-2">
                    <div className={`px-4 py-2 border-b ${isDark ? 'border-gray-700' : 'border-gray-200'}`}>
                      <p className={`text-sm font-medium ${isDark ? 'text-white' : 'text-gray-900'}`}>{fullName || 'User'}</p>
                      <p className={`text-xs ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>{email || 'No Email'}</p>
                    </div>
                    <a href="#" className={`block px-4 py-2 text-sm transition-colors ${isDark ? 'text-gray-300 hover:bg-gray-700 hover:text-white' : 'text-gray-700 hover:bg-gray-100'}`}>Profile Settings</a>
                    <a href="#" className={`block px-4 py-2 text-sm transition-colors ${isDark ? 'text-gray-300 hover:bg-gray-700 hover:text-white' : 'text-gray-700 hover:bg-gray-100'}`}>System Settings</a>
                    <div className={`border-t ${isDark ? 'border-gray-700' : 'border-gray-200'} mt-2 pt-2`}>
                      <button 
                        onClick={handleSignOut} 
                        className={`block w-full text-left px-4 py-2 text-sm transition-colors ${isDark ? 'text-red-400 hover:bg-gray-700' : 'text-red-600 hover:bg-gray-100'}`}
                      >
                        Sign Out
                      </button>
                    </div>
